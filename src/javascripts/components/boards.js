  ...
  array.forEach((item) => {
    ...
    <div class="board-container top m-3" style="width: 20rem">
      ...
      <div class="middle">
        ...
        <br>
        <div="card-text">
        <p class="card-text mt-3"><span class="badge">${item.favorite ? "<i class='fas fa-star' style='font-size:24px'></i>" : ''}</span><span class="badge">${item.public ? "<i class='fas fa-globe-americas ml-1' style='font-size:24px'></i>" : ''}</span></p>
        </div>
        <br>
        <div class="socials">
